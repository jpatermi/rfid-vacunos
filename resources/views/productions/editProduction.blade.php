    ...
    <div class="card">
      <div class="card-header">
        <div class="d-flex justify-content-between align-items-end p-2">
          <h3>Actualizar Producción para el Animal:
      ...
      <div class="card-body">
        ...
        <form method = "POST" action="{{ route('productions.update', $production) }}">
          ...
          <div class="form-row nav justify-content-center">
            <div class="form-group col-md-8">
                ...
                <div class="input-group date">
                    <input type="text" class="form-control datepicker" name="dateface" id="dateface" placeholder="dd/mm/aaaa" autocomplete="off" value="{{ old('dateface', $production->production_date) }}">
            ...
            <div class="form-group col-md-8">
              ...
              <input type="text" class="form-control" name="colostrum" id="colostrum" placeholder="0.00" value="{{ old('colostrum', $production->colostrum) }}">
            ...
            <div class="form-group col-md-8">
              ...
              <input type="text" class="form-control" name="milk" id="milk" placeholder="0.00" value="{{ old('milk', $production->milk) }}">
              @if($errors->has('milk'))
          ...
          <input type="text" name="production_date" id="production_date" hidden value="{{ $production->production_date }}">
          <!-- -->
          <div class="form-row nav justify-content-center">
