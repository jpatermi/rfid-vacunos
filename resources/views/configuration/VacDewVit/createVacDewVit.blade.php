			...
			<form method = "POST" action="{{ route($model . '.store') }}">
				...
				<div class="form-row nav justify-content-center">
				    <div class="form-group col-md-8">
						...
						<input type="text" class="form-control" name="name" id="name" placeholder="Nombre {{ $labelVacDewVit }}" value="{{ old('name') }}">
						@if($errors->has('name'))
				    ...
				    <div class="form-group col-md-8">
						...
						<input type="text" class="form-control" name="characteristic" id="characteristic" placeholder="Característica {{ $labelVacDewVit }}" value="{{ old('characteristic') }}">
	                ...
	                <div class="form-group col-md-8">
	                    ...
	                    <div class="input-group date">
	                        <input type="text" class="form-control datepickerV" name="dateface" id="dateface" placeholder="dd/mm/aaaa" autocomplete="off" value="{{ old('dateface') }}">
				    ...
				    <div class="form-group col-md-8">
						...
						<input type="text" class="form-control" name="lot" id="lot" placeholder="Lote {{ $labelVacDewVit }}" value="{{ old('lot') }}">
						@if($errors->has('lot'))
				...
				<input type="text" name="expiration_date" id="expiration_date" hidden value="{{ old('expiration_date') }}">
				<!-- -->
				@endif
				<div class="form-row nav justify-content-center">
					<button type="submit" class="btn btn-primary">Agregar {{ $labelVacDewVit }}</button>
				</div>
			</form>
		</div>
