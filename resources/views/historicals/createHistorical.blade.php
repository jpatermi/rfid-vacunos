  ...
  <div class="justify-content-center">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <form method = "POST" action="{{ route('historicals.store') }}">
          @csrf
          <div class="form-row nav justify-content-center">
            ...
            <div class="form-group col-md-8">
              ...
              <input type="text" class="form-control" name="weight" id="weight" placeholder="0.00" value="{{ old('weight') }}">
            ...
            <div class="form-group col-md-8">
              ...
              <input type="text" class="form-control" name="height" id="height" placeholder="00" value="{{ old('height') }}">
          ...
          <input type="text" name="measurement_date" id="measurement_date" hidden value="{{ old('measurement_date') }}">
          <!-- -->
          <div class="form-row nav justify-content-center">
            <button type="submit" class="btn btn-primary">Agregar Histórico</button>
          </div>
        </form>
      </div>
